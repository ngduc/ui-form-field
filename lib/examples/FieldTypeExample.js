    ...
    function default_1() {
        ...
        _this.renderForm = function (props) {
            return (React.createElement(UIForm_1["default"], { use: "bootstrap4" },
                ...
                React.createElement(UIField_1["default"], { singleSelect: true, options: Utils_2.animals.slice(1), name: "singleSelect" }),
                React.createElement(UIField_1["default"], { multiSelect: true, options: Utils_2.animals.slice(1), name: "multiSelect" }),
                React.createElement(UIField_1["default"], { tagSelect: true, name: "tags", options: Utils_2.animals.slice(1) }),
