    ...
    function default_1() {
        ...
        _this.renderForm = function (props) {
            ...
            return (React.createElement(UIForm_1["default"], { use: "bootstrap4" },
                React.createElement(UIField_1["default"], null, "Email | email"),
                React.createElement(UIField_1["default"], { radios: true, options: exports.genders, onChange: function () { return _this.onChangeGender(props); } }, "Gender | gender"),
