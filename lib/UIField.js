...
var UIField = function (props) {
    ...
    var ErrorMessage = function () {
        return hasErrors ? React.createElement("span", { className: errorClass }, Utils_1.deepFind(errors, fieldName)) : null;
    };
    ...
    if (props.custom) {
        return (React.createElement("div", { className: mainClassName },
            ...
            React.createElement(props.custom, __assign({}, props, { fieldName: fieldName, className: "" + (hasErrors ? classes.invalidControl : '') })),
    ...
    return (React.createElement("div", { className: mainClassName },
        ...
        React.createElement(formik_1.FastField, __assign({ name: fieldName, placeholder: placeholder, onChange: function (ev) {
                ...
                if (Utils_1.deepFind(ev, 'nativeEvent.target.tagName') === 'INPUT') {
                    props.onChange &&
                        props.onChange({ value: Utils_1.deepFind(ev, 'nativeEvent.target.value'), event: ev, formik: props.formik }); // input's value
                }
                else {
