...
var SingleSelect_1 = require("./custom/SingleSelect");
var MultiSelect_1 = require("./custom/MultiSelect");
...
var UIField = function (props) {
    ...
    var hasErrors = _get(props.formik.errors, fieldName) &&
    ...
    var Label = function (props) { return (React.createElement("label", { htmlFor: props["for"] || fieldName, className: labelClass }, labelText)); };
    ...
    if (props.singleSelect) {
        return (React.createElement("div", { className: mainClassName },
            ...
            React.createElement(SingleSelect_1["default"], __assign({}, props, { className: "" + (hasErrors ? classes.invalidControl : '') })),
    ...
    if (props.multiSelect) {
        return (React.createElement("div", { className: mainClassName },
            React.createElement(Label, null),
            React.createElement(MultiSelect_1["default"], __assign({}, props, { className: "" + (hasErrors ? classes.invalidControl : '') })),
            React.createElement("small", { className: helpClass }, props.help),
            React.createElement(ErrorMessage, null)));
    }
    // ------ render <Field row .../>
    ...
    if (props.tagSelect) {
        ...
        return (React.createElement("div", { className: mainClassName },
            ...
            React.createElement(ReactTags, __assign({ addOnBlur: true, allowNew: true, allowBackspace: true, autofocus: false, minQueryLength: 0, tags: tags, placeholder: placeholder, suggestions: suggestions, handleValidate: function (_a) {
                    ...
                    values_1.push(foundOpt ? foundOpt.value : name);
                    props.formik.setFieldValue(fieldName, values_1);
                    props.onChange && props.onChange(values_1);
